...
Sou um desenvolvedor apaixonado por tecnologia, focado no ecossistema JavaScript/TypeScript. Possuo conhecimentos no desenvolvimento de APIs robustas (Back-end) e estruturação de interfaces funcionais, e atualmente estou aprimorando meu repertório no front-end com React.
...
📈 Resumo das Stacks
JavaScript (ES6+) | TypeScript | Node.js | Express | MongoDB | CSS3 | React (Learning)
